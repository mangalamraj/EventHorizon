      ...
      <main className="pt-8 flex flex-col justify-center items-center gap-8">
        <>
          ...
          <div className="container flex justify-center flex-col items-center gap-4">
            ...
            <div className="md:text-2xl w-full text-lg text-center font-medium text-slate-400 dark:text-slate-200 ">
              Experience the Connected Workspace of EventHorizon for Enhanced
              Efficiency.
            </div>
          </div>
        </>
        ...
        <div className="flex gap-4 items-center md:flex-row flex-col">
          <Button className="font-semibold text-md">
            {" "}
            EventHorizon Free <ArrowRight className="ml-1 h-5 w-5" />
          </Button>

          <div className="text-[#0a85d1] font-normal text-xl hover:underline cursor-pointer">
            Request a demo
          </div>
        </div>
